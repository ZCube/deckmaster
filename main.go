...
func eventLoop(dev streamdeck.DeviceInterface, tch chan interface{}) error {
...
func closeDevice(dev streamdeck.DeviceInterface) {
	fmt.Println("Closing Stream Deck")
...
func initDevice() (streamdeck.DeviceInterface, error) {
